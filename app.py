...
from lenetSettings import Ui_MainWindow as LNCP
from alexnetSettings import Ui_MainWindow as ANCP
...
class Ui_MainWindow(object):
    ...
    def openWin(self):
        ...
        from PIL import Image
        # creating a object
        im = Image.open(r"img/AlexNet.png")
        im.show()
        self.window.show()
